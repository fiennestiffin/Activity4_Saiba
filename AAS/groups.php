...
<body>
    <div class="main-div">
                ...
                <div class="tabs-container">
                    <ul class="nav nav-pills nav-fill d-flex flex-column">
                        <li class="nav-item tabs-dashboard">
                            <a class="nav-link groups d-flex flex-row " aria-current="page" href="dashboard.php">
                        ...
                        <li class="nav-item tabs-groups">
                            <a class="nav-link groups active d-flex flex-row " aria-current="page" href="groups.php">
        ...
        <div class="white-div d-flex flex-column align-items-center">
            ...
            <div class="groups-main-div d-flex flex-row">
